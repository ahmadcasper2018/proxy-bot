...
gift_message = "🔻 أرسل معرّف ( Id ) صديقك الذي ترغب بالتحويل من رصيدك لرصيده"

socks9message = """سعر البروكسي 1 Credit
مدة البروكسي تتراوح بين 1-24 ساعة
يتم خصمه من رصيد باقتك.
علماً انك تستطيع شراء باقة بروكسيات من خلال زر شراء باقة
اختر الدولة المناسبة لك 👇🏻 :"""


perms_message = (
    "سعر البروكسي 350 ل.س\nيتم خصمه من رصيدك .\nاختر الدولة المناسبة لك 👇🏻 :"
)
